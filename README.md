...
This fork creates a modified UI with different pushbutton functionality. I also included 16 predefined bands that can be selected with the encoder. A colored waterfallis now also available.
Audio record and save to flash heve been removed sice both did not work for me. Experimental touch screen support has been included. To use the touch screen, uncomment //#define USE_TOUCH_SCREEN in hmi.h.
