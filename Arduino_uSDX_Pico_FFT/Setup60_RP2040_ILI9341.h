...
#define TFT_MISO  12  //0  RX   !! This needs to be set to GPIO 12 if the touch controller is in use, otherwise not
...
// optional. will use GPIO 12 and 14 for MISO and CS
#define TOUCH_CS 14     // Chip select pin (T_CS) of touch screen
#define TOUCH_CLK  10   // SPI clock
//#define TOUCH_MOSI 11   // SPI MOSI
#define TOUCH_MISO 12   // SPI MISO
#define TOUCH_IRQ 0
